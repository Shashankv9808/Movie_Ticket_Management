...
namespace BangloreTalkies.Data
{
    internal class SampleData
    {
        ...
        internal List<MovieItem> GetHeroSliderMovies()
        {
        ...
        internal List<MovieItem> GetAllRecentMovies()
        {
        ...
        internal List<ShowtimeItem> GetMovieShowtimes(int movieId)
        {
        ...
        internal List<MovieItem> GetSimilarMovies(string genre, int excludeId)
        {
        ...
        internal List<EventItem> GetUpcomingEvents()
        {
        ...
        internal List<EventItem> GetMusicEvents()
        {
            return GetUpcomingEvents().Where(e => e.Category.Contains("Music")).ToList();
        }

        internal List<EventItem> GetSportsEvents()
        {
            return new List<EventItem>
            {
        ...
        internal List<EventItem> GetComedyShows()
        {
            return new List<EventItem>
            {
        ...
        internal List<ActivityItem> GetActivities()
        {
