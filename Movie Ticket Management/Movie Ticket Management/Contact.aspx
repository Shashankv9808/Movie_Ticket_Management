<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Movie_Ticket_Management.Contact" %>
...
<body style="width: 102%">
    <form id="form1" runat="server">
        <!--slidenav-->
        <div id="mySidenav" class="auto-style9" runat="server">
...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
    ...
    <div id="header" class="auto-style7"><!--header -->
        ...
        <div>
            <asp:ImageButton ID="ImageButton1" runat="server" CssClass="auto-style10" Enabled="False" ImageUrl="~/images/contact us.jpg" />
        </div>       
        <asp:Label ID="Label1" runat="server" CssClass="auto-style11" Font-Bold="False" Font-Italic="True" Font-Names="Berlin Sans FB" Font-Size="XX-Large" Text="Contact us"></asp:Label>
        <asp:Label ID="Label2" runat="server" CssClass="auto-style12" Text="+91326547888"></asp:Label>
        <asp:Label ID="Label3" runat="server" CssClass="auto-style13" Text="bangloremovies@info.com"></asp:Label>
    </form>
