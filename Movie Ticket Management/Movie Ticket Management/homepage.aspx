<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homepage.aspx.cs" Inherits="Movie_Ticket_Management.WebForm1" %>
...
<body style="width: 102%">
    <form id="form1" runat="server">
        ...
        <asp:Repeater ID="MovieRepeater" runat="server" OnItemDataBound="MovieRepeater_ItemDataBound">
            ...
            <div>
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Book Antiqua" Font-Size="Large" ForeColor="Black" style="top: 121px; left: 104px; position: absolute; height: 27px; width: 173px" Text="Treanding Movies" Font-Underline="False"></asp:Label>
                <asp:HyperLink ID="HyperLink1" runat="server" BackColor="#F2F2F2" Font-Names="Book Antiqua" Font-Underline="False" ForeColor="Blue" NavigateUrl="movielist.aspx" style="top: 119px; left: 1260px; position: absolute; height: 18px; width: 70px">ViewAll</asp:HyperLink>
            </div>       
    </form>    
</body>
</html>
