<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookhistory.aspx.cs" Inherits="Movie_Ticket_Management.bookhistory" %>
...
<body style="width: 102%; height: 304px;">
  ...
  document.getElementById("mySidenav").style.width = "0";
    ...
    <div id="header" class="auto-style7"><!--header -->
        ...
        <div style="background-image:url('/images/user-profile.jpg');" class="auto-style9">
            ...
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Font-Names="Bell MT" Font-Size="X-Large" ForeColor="White" Text="Fell Free To See Your Information,"></asp:Label>
